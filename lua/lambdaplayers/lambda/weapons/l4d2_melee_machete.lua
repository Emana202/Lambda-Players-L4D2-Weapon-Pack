table.Merge( _LAMBDAPLAYERSWEAPONS, {
    l4d2_melee_machete = {
        ...
        OnEquip = function( self, wepent )
            ...
            wepent.L4D2Data.RateOfFire = { 0.625, 0.675 }
            wepent.L4D2Data.Sound = {
                "lambdaplayers/weapons/l4d2/melee/machete/machete_swing_miss1.mp3",
                "lambdaplayers/weapons/l4d2/melee/machete/machete_swing_miss2.mp3"
            }
